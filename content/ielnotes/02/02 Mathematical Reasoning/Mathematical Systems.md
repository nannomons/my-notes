...
2. One or more relations expressing *some kind of comparison* among elements in the set **($<, >, =, \geq, \leq$)** 
3. One or more *operations* on the set of elements **($+, -, *, /$, exponents, radicals)**
